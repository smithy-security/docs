---
title: "Customizing Smithy Components: Semgrep Example"
...
Currently, the Semgrep component uses the default ruleset. It does allow users to specify custom rules from the free rulesets but not pro rules.
...
## [Advanced] Using Completely Custom Semgrep Rules in a Workflow
